...
async function main() {
  ...
  if (args.length < 1 || args[0] === "--help" || args[0] === "-h") {
    console.log("Usage: yarn ts-node scripts/update-pause-authority.ts <NEW_PAUSE_AUTHORITY>");
    console.log();
    ...
    console.log("  yarn ts-node scripts/update-pause-authority.ts 9TcjK2ToqoAtCr5jrLdDXNTNbZBbDQB1zy2BNGMr7nQE");
    console.log();
    console.log("Note: You must be the current pause authority to execute this.");
  ...
  console.log("- Current Pause Authority:", poolAccount.pauseAuthority.toString());
  ...
  if (!poolAccount.pauseAuthority.equals(payer.publicKey)) {
    ...
    console.error(`   Current pause authority is: ${poolAccount.pauseAuthority.toString()}`);
  ...
  console.log("   - Manage the whitelist");
  ...
  try {
    ...
    console.log("- Old Pause Authority:", poolAccount.pauseAuthority.toString());
    console.log("- New Pause Authority:", newPauseAuthority.toString());
    console.log();
