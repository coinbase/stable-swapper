...
async function main() {
  ...
  const current = poolAccount.pauseAuthority;
  ...
  console.log("- Current Pause Authority:", current.toString());
  console.log("- Your Wallet:", payer.publicKey.toString());
  console.log("- New Pause Authority:", next.toString());
  ...
  console.log("✅ Pause Authority rotated.");
