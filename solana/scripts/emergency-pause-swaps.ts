...
async function main() {
  ...
  if (args[0] === "--help" || args[0] === "-h") {
    console.log("Usage: yarn ts-node scripts/emergency-pause-swaps.ts [PAUSED]");
    console.log();
    console.log("Arguments:");
    console.log("  PAUSED     true to pause swaps, false to unpause (optional, defaults to true)");
    console.log();
    console.log("Examples:");
    console.log("  # Pause swaps (emergency)");
    console.log("  yarn ts-node scripts/emergency-pause-swaps.ts");
    console.log("  yarn ts-node scripts/emergency-pause-swaps.ts true");
    console.log();
    console.log("  # Unpause swaps (restore normal operations)");
    console.log("  yarn ts-node scripts/emergency-pause-swaps.ts false");
    process.exit(0);
  }
  ...
  console.log("EMERGENCY PAUSE SWAPS");
  console.log("=".repeat(60));
  console.log();
  ...
  if (poolAccount.swapsPaused === paused) {
    console.log(`ℹ️  Swaps are already ${paused ? 'paused' : 'unpaused'}`);
    process.exit(0);
  }

  console.log(`${paused ? '⚠️  PAUSING SWAPS' : '✅ UNPAUSING SWAPS'}`);
  ...
  try {
    ...
    console.log(`${paused ? '🛑' : '✅'} Swaps ${paused ? 'paused' : 'unpaused'} successfully!`);
    console.log();
    ...
    console.log("- Swaps Paused:", paused);
    console.log();

    console.log("=".repeat(60));
    console.log(`${paused ? '🛑 SWAPS PAUSED' : '✅ SWAPS RESTORED'}`);
    console.log("=".repeat(60));
